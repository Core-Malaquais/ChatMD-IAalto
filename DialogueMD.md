...
Bonjour, je suis @{_bot_name}, un Chatbot programmé pour répondre à vos questions concernant votre vie à l'ENSA Paris-Malaquais.
...
[Taïga](https://etudiant.archi.fr/taiga/etd/index.php?ce=malq) est le portail permettant d'accéder à vos informations de scolarité : fiches d'enseignement, certificats de scolarité, attestations d'inscription...

Que souhaitez-vous faire ?

1. [Je n'arrive pas à me connecter](taiga_connexion)
2. [Je veux télécharger un document administratif (ex : certificat de scolarité)](taiga_document)
3. [Consulter mon relevé de note](taiga_note)
4. [Modifier mes informations personnelles](taiga_information)

## taiga_connexion
- problème connexion taïga
- mot de passe oublié
...
Pour vous connecter à [Taïga](https://etudiant.archi.fr/taiga/etd/index.php?ce=malq), utilisez `prénom.nom` comme identifiant et saisissez votre mot de passe qui est le même que sur Office 365.

\`
:::info
Si vous n'avez pas de mot de passe, lancez la procédure de mot de passe oublié ou contactez le service pédagogique.
:::
\`
...
Pour télécharger votre document administratif dans [Taïga](https://etudiant.archi.fr/taiga/etd/index.php?ce=malq), rendez-vous dans le menu `Global -> Données personnelles`.

1. [Comment se connecter à Taïga ?](taiga_connexion)
...
Pour visualiser votre relevé de note dans [Taïga](https://etudiant.archi.fr/taiga/etd/index.php?ce=malq), rendez-vous dans le menu `Global -> Relevé de note`.

\`
:::info
Vos notes ne sont visibles qu'une fois saisies par votre enseignant référent.
:::
\`
...
## taiga_information
- taïga information
- informations personnelles taïga
- données personnelles taïga
- ! IA
- ! AI
- ! intelligence artificielle

Vous pouvez modifier vos données personnelles à tout moment sur [Taïga](https://etudiant.archi.fr/taiga/etd/index.php?ce=malq) dans le menu `Global -> Données personnelles`
...
Pour toute information à propos du projet @{_bot_name}, merci de contacter mon créateur [Corentin BOITEAU](mailto:corentin.boiteau@paris-malaquais.archi.fr).
...
Les horaires et modalités sont communiqués par l’administration ou les responsables d’atelier.
...
1. Vérifier que tu es formé à son utilisation
2. Accéder au planning de réservation
3. Choisir un créneau disponible
4. Préparer ton fichier en amont

Choisis une machine :

1. [Découpe laser](resa_laser)
2. [Fraiseuse CNC](resa_cnc)
3. [Cutter numérique](resa_cutter)
4. [Imprimantes 3D](resa_print)
...
- Validation technique souvent nécessaire
- Préparation des parcours d’outils

Conseil :
Toujours tester à petite échelle avant usinage final.

---

## resa_cutter
Réservation cutter numérique :
- Idéal pour maquettes rapides
...
## resa_print
Réservation imprimantes 3D :
- Temps long (plusieurs heures)
- Lancer l’impression en avance
- Vérifier les supports et paramètres

---

## machines
Voici les machines disponibles à l’atelier :

- Imprimantes 3D (Prusa Mini)
- Impression 3D terre (WASP)
- Découpe laser (Speedy 400 Trotec)
- Fraiseuse CNC
- Cutter numérique (Valiani)
- Découpe jet d’eau (Wazer)
- Bras robot ABB
- Banc d’essai 3R
- Thermoformeuse

Chaque machine a ses contraintes et ses matériaux spécifiques.
...
Choisis une machine pour connaître les matériaux compatibles :

1. [Découpe laser](mat_laser)
2. [CNC](mat_cnc)
3. [Impression 3D](mat_print)
4. [Impression terre](mat_clay)
5. [Jet d’eau](mat_waterjet)
6. [Thermoformeuse](mat_thermo)

---

## mat_laser
Matériaux compatibles découpe laser :
- Carton
- MDF
- Contreplaqué fin
- Acrylique (plexiglas)
...
## mat_clay
Matériaux impression terre :
- Argile
- Mélanges terreux adaptés
